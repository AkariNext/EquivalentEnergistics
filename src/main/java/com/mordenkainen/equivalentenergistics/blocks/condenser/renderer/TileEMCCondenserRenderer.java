...
public class TileEMCCondenserRenderer extends HollowTileRenderer {
    ...
    public void renderTileEntityAt(final TileEntity tile, final double x, final double y, final double z,
        ...
        if (condenser.getWorldObj() != null) {
            if (condenser.isActive()) {
                ...
                final IIcon tex = condenser.getState().isError() ? TextureEnum.EMCCONDENSER.getTexture(1)
                        : TextureEnum.EMCCONDENSER.getTexture(0);
    ...
    private void renderContent(final TileEMCCondenserBase tile, final double x, final double y, final double z,
            final float partialTicks) {
