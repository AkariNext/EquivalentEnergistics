...
public class TileEMCCrafterRenderer extends TileEntitySpecialRenderer {
    ...
    private void renderLights(final TileEMCCrafterBase tile, final double x, final double y, final double z) {
        ...
        final IIcon tex = tile.isErrored() ? TextureEnum.EMCASSEMBLER.getTexture(1)
                : TextureEnum.EMCASSEMBLER.getTexture(0);
    ...
    private void renderContent(final TileEMCCrafterBase tile, final double x, final double y, final double z,
            final float partialTicks) {
    ...
    private boolean isCableConnected(final IBlockAccess world, final int x, final int y, final int z,
