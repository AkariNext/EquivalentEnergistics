...
public class TileEMCProviderRenderer extends HollowTileRenderer {
    ...
    private static final ResourceLocation MODELTEXTURE = new ResourceLocation(
            Reference.MOD_ID + ":textures/models/EMCProvider.png");
    ...
    private void renderContent(final TileEMCPatternProvider tile, final double x, final double y, final double z,
            final float partialTicks) {
