...
public final class CraftingManager {
    ...
    public static void initRecipes() {
        ...
        if (!ConfigManager.useEE3) {
            GameRegistry.addShapedRecipe(
                    ItemEnum.EMCBOOK.getSizedStack(1),
                    new Object[] { " D ", "DBD", " D ", 'D', dust, 'B', Items.book });
        }
    ...
    private static void initCellRecipies() {
        ...
        GameRegistry.addRecipe(
                new ShapedOreRecipe(
                        ItemEnum.CELLCOMPONENT.getDamagedStack(0),
                        "DCD",
                        "CLC",
                        "DCD",
                        'D',
                        ...
                        quartzCrystals,
                        'L',
                        new ItemStack(aeMaterial, 1, 22))); // NOPMD
        for (int i = 1; i < 4; i++) {
            GameRegistry.addShapedRecipe(
                    ItemEnum.CELLCOMPONENT.getDamagedStack(i),
                    "DCD",
    ...
    private static void initCrafterRecipies() {
        GameRegistry.addShapedRecipe(
                new ItemStack(BlockEnum.EMCCRAFTER.getBlock()),
                new Object[] { "CDC", "DFD", "CDC", 'C', base, 'D', dust, 'F', new ItemStack(aeMaterial, 1, 43) });
        GameRegistry.addRecipe(
                new ShapedOreRecipe(
                        new ItemStack(BlockEnum.EMCCRAFTER.getBlock(), 1, 1),
                        new Object[] { "GGG", "GRG", "GGG", 'R', new ItemStack(BlockEnum.EMCCRAFTER.getBlock()), 'G',
                                "gemDiamond" }));
        GameRegistry.addRecipe(
                new ShapedOreRecipe(
                        new ItemStack(BlockEnum.EMCCRAFTER.getBlock(), 1, 2),
                        new Object[] { "MMM", "MRM", "MMM", 'R', new ItemStack(BlockEnum.EMCCRAFTER.getBlock(), 1, 1),
                                'M', "gemEmerald" }));
        GameRegistry.addShapedRecipe(
                new ItemStack(BlockEnum.EMCCRAFTER.getBlock(), 1, 3),
                new Object[] { "SSS", "SRS", "SSS", 'R', new ItemStack(BlockEnum.EMCCRAFTER.getBlock(), 1, 2), 'S',
                        Items.nether_star });
    }

    private static void initCondenserRecipies() {
        GameRegistry.addShapedRecipe(
                new ItemStack(BlockEnum.EMCCONDENSER.getBlock()),
                new Object[] { "BDB", "BAB", "BDB", 'B', base, 'D', dust, 'A', new ItemStack(aeMaterial, 1, 44) });
        GameRegistry.addRecipe(
                new ShapedOreRecipe(
                        new ItemStack(BlockEnum.EMCCONDENSER.getBlock(), 1, 1),
                        new Object[] { "DDD", "DCD", "DDD", 'C', new ItemStack(BlockEnum.EMCCONDENSER.getBlock()), 'D',
                                "gemDiamond" }));
        GameRegistry.addRecipe(
                new ShapedOreRecipe(
                        new ItemStack(BlockEnum.EMCCONDENSER.getBlock(), 1, 2),
                        new Object[] { "EEE", "ECE", "EEE", 'C', new ItemStack(BlockEnum.EMCCONDENSER.getBlock(), 1, 1),
                                'E', "gemEmerald" }));
        GameRegistry.addShapedRecipe(
                new ItemStack(BlockEnum.EMCCONDENSER.getBlock(), 1, 3),
                new Object[] { "NNN", "NCN", "NNN", 'C', new ItemStack(BlockEnum.EMCCONDENSER.getBlock(), 1, 2), 'N',
                        Items.nether_star });
    }
